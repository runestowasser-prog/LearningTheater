...
// Gem original
/*const __ActorPropsOriginal = ActorProps;
...
function resolveAsset(value) {
    ...
    // Hvis vi er i editor og har Project
    if (window.Project && Project.assets && Project.assets[value]) {
        return Project.assets[value].url;
    }

    // Ellers returner original
    return value;
}*/
